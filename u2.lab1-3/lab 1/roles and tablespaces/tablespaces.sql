...
SIZE 150M reuse
 ...
 CREATE TABLESPACE ts_sa_fact_sales_data_01
DATAFILE '/oracle/u02/oradata/SNasekajlodb/db_qpt_sa_pizzerias_data_01.dat'
SIZE 150M reuse
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;
...
DROP TABLESPACE ts_sa_dim_owner_01 INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
DROP USER SA_CUSTOMER CASCADE;
