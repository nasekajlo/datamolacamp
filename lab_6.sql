...
ALTER SYSTEM SET db_create_file_dest = '/oracle/u02/oradata/SNasekajlodb';
...
DATAFILE '/oracle/u02/oradata/SNasekajlodb/db_qpt_dw_idx_01.dat'
SIZE 150M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_persons_data_01
DATAFILE '/oracle/u02/oradata/SNasekajlodb/db_qpt_person_data_01.dat'
SIZE 150M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_persons_idx_01
DATAFILE '/oracle/u02/oradata/SNasekajlodb/db_qpt_person_idx_01.dat'
SIZE 50M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_references_data_01
DATAFILE '/oracle/u02/oradata/SNasekajlodb/db_qpt_references_data_01.dat'
SIZE 150M
 AUTOEXTEND ON NEXT 50
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_references_ext_data_01
DATAFILE '/oracle/u02/oradata/SNasekajlodb/db_qpt_ext_references_data_01.dat'
SIZE 20M
 AUTOEXTEND ON
    NEXT 20M
    MAXSIZE 60M
...
DATAFILE '/oracle/u02/oradata/SNasekajlodb/db_qpt_references_idx_01.dat'
SIZE 50M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;
...
select * from all_tables where owner=UPPER ('u_dw_ext_references');
...
insert into u_dw_references.lc_lng_scopes
values (1, 'E', 'English', 1);
insert into u_dw_references.lc_lng_scopes
values (1, 'Р', 'Русский', 2);
commit;
...
select * from u_dw_references.t_languages;
...
exec pkg_load_ext_ref_languages.load_cls_languages;
